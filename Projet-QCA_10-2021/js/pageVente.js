...
window.addEventListener('scroll', function(){
    ...
    if(position < scroll){
        if((imageDistanceTop - (window.innerHeight)/1.5) <0 && (imageDistanceTop - window.innerHeight/4) > 0){
            ...
            img1.style.transition = "transform 0.4s ease-in"
            img2.style.transition = "transform 0.4s ease-in"
            img3.style.transition = "transform 0.4s ease-in"
            img4.style.transition = "transform 0.4s ease-in"
        } else {
